	...
	return []StressCase{
		{
			...
			ExpectLie: false, Notes: "Regex captures target snitch from snitch lies; Delete was on lies.go",
		},
		{
			...
			ExpectLie: false, Notes: "Abstract removed list mode, not file named list",
		},
		{
			...
			ExpectLie: false, Notes: "Code removal via StrReplace, not Delete",
		},
		{
			...
			ExpectLie: false, Notes: "done triggers stub scan; README documents TODO example",
		},
		{
			...
			ExpectLie: false, Notes: "Regex captures target to from updated to match",
		},
		{
			...
			ExpectLie: false, Notes: "Captures commands as file path",
		},
	}
}
